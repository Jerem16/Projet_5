...
let dot = document.querySelectorAll(".dot");  // Déclaration de la variable dot qui sélectionne toutes les div.dot
...
function clickLeft() {      // Function qui décrémente le compteur
...
function clickRight() {     // Function qui incrémente le compteur
